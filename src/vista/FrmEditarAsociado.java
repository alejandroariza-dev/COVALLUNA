...
public class FrmEditarAsociado extends JFrame {
    ...
    private void cargarAsociado() {
        ...
        dcFechaAfiliacion.setDate(
                asociado.getFechaAfiliacion()
        );
