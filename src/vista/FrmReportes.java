...
public class FrmReportes extends JFrame {
    ...
    private JPanel crearTabReporte3() {

        JPanel panel = new JPanel(null);

        JLabel lblTitulo = new JLabel(
                "Estado de Cartera por Línea y Estado"
        );
        ...
        JLabel lblAgencia =
                new JLabel("Agencia (código):");

        lblAgencia.setBounds(10, 50, 140, 25);
        ...
        txtAgencia.setBounds(155, 50, 150, 25);
    ...
    private JPanel crearTabReporte6() {

        JPanel panel = new JPanel(null);

        JLabel lblTitulo = new JLabel(
                "Productividad de Asesores por Agencia"
        );
        ...
        modelo.addColumn("Cédula Asesor");
        modelo.addColumn("Nombres");
        modelo.addColumn("Apellidos");
        modelo.addColumn("Agencia");
        modelo.addColumn("Asociados Atendidos");
        modelo.addColumn("Créditos Radicados");
        ...
        btnGenerar.addActionListener(e -> {
            ...
            ArrayList<modelo.Empleado> empleados =
                    empleadoDAO.listar();

            for (modelo.Empleado emp : empleados) {

                boolean coincideAgencia =
                        agenciaFiltro.isEmpty()
                        ||
                        emp.getCodigoAgencia()
                                .equalsIgnoreCase(
                                        agenciaFiltro
                                );
    ...
    private JPanel crearTabReporte7() {

        JPanel panel = new JPanel(null);

        JLabel lblTitulo = new JLabel(
                "Créditos con Codeudoría Activa"
        );
        ...
        modelo.addColumn("Codeudor");
        modelo.addColumn("Fecha Firma Pagaré");
        modelo.addColumn("Val. Aprobado");
        modelo.addColumn("Estado Crédito");
        ...
        btnGenerar.addActionListener(e -> {
            ...
            ArrayList<modelo.Garantia> garantias =
                    creditoDAO.listarGarantias();

            for (modelo.Garantia g : garantias) {
                ...
                modelo.addRow(
                        new Object[]{
                                ...
                                g.getCedulaTitular(),
                                g.getCedulaCodeudor(),
                                g.getFechaFirmaPagare(),
                                String.format("$%.2f", g.getValorAprobado()),
                                g.getEstadoCredito()
                        }
                );
            }
